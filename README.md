...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/pystencils-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/pystencils-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi global install pystencils
```
...
It is possible to list all of the versions of `pystencils` available on your platform:
...
```
pixi search pystencils --channel conda-forge
```
